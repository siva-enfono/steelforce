...
def execute(filters=None):
    ...
    pos_profiles = filters.get("pos_profile")   # MULTI SELECT
    ...
    if pos_profiles:
        ...
        if pos_profiles:
            pos_condition = " AND si.pos_profile IN %(pos_profiles)s "
            pos_values["pos_profiles"] = tuple(pos_profiles)
